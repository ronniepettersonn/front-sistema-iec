...
function FilterButton() {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600 dark:hover:text-slate-500 dark:hover:border-slate-400 dark:bg-slate-600 dark:border-slate-500"
        aria-haspopup="true"
