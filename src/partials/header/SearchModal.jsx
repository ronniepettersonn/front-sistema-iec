...
function SearchModal({
  ...
  return (
    <>
      ...
      >
        <div ref={modalContent} className="bg-slate-700 border border-slate-500 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
          {/* Search form */}
          <form className="border-b border-slate-700" onSubmit={(e) => handleSubmit(e)}>
            <div className="relative">
              <label htmlFor={searchId} className="sr-only">Buscar</label>
              <input id={searchId} className="bg-slate-700 w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Buscar por membro…" value={search} ref={searchInput} onChange={e => setSearch(e.target.value)} />
