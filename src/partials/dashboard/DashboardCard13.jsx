...
function DashboardCard13() {
  return (
    <div className={`col-span-full ${/* xl:col-span-6 */ ''} shadow-lg rounded-lg bg-gray-800 border-gray-700 border `}>
      <header className="px-5 py-4 border-b border-gray-700">
        <h2 className="font-semibold text-slate-200">Income/Expenses</h2>
      </header>
      <div className="p-3">
        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-gray-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-200 hover:text-slate-900" href="#0">Qonto</a> billing</div>
                  <div className="shrink-0 self-start ml-2">
                    <span className="font-medium text-slate-200">-$49.88</span>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-gray-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-200 hover:text-slate-900" href="#0">Cruip.com</a> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-gray-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-200 hover:text-slate-900" href="#0">Notion Labs Inc</a></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-gray-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-200 hover:text-slate-900" href="#0">Market Cap Ltd</a></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-gray-700 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-200 hover:text-slate-900" href="#0">App.com</a> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
                    <span className="font-medium text-slate-200 line-through">+$99.99</span>
                  </div>
                </div>
              </div>
            </li>
