                ...
                <div className="p-8">
                    ...
                    <div className='flex pb-8 border-b border-slate-700 justify-between items-center'>
                        <div className="flex items-center justify-between">
                            <h1 className="text-2xl font-bold leading-none text-gray-900 dark:text-white">Cadastro de Pregação</h1>
                        </div>

                        <Link to='/agenda/pregacao'>
                ...
                <div className='flex flex-col flex-1 px-8 w-full '>
                    ...
                    <form className='w-full border-b border-b-slate-700' onSubmit={handleSubmit(onSubmit)} id='formVisit'>
                        ...
                        <div className='grid md:grid-cols-3 md:gap-6'>
                            ...
                            <div className="mb-6">
                                <label htmlFor="name_minister" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome do Ministro</label>
                            ...
                            <div className="mb-6">
                                <label htmlFor="name_dirigent" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome do Dirigente</label>
                                <input type="text" id="name_dirigent" className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white  ${errors.name ? 'dark:focus:border-red-500 dark:focus:ring-red-500 border-red-500 dark:border-red-900' : 'dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:border-gray-600'}`} {...register('name_dirigent')} />
