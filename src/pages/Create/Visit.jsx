                    ...
                    <form className='w-full border-b border-b-slate-700' onSubmit={handleSubmit(onSubmit)} id='formVisit'>
                        ...
                        <div className='grid md:grid-cols-2 md:gap-6'>
                            ...
                            <div className="mb-6">
                                ...
                                <input type="tel" pattern='(\([0-9]{2}\))\s([9]{1})\s([0-9]{4})-([0-9]{4})' placeholder='(99) 9 9999-9999' id="tel" className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white ${errors.tel ? 'dark:focus:border-red-500 dark:focus:ring-red-500 border-red-500 dark:border-red-900' : 'dark:focus:ring-blue-500 dark:focus:border-blue-500 border-gray-300 dark:border-gray-600'}`} {...register('tel')} />

                                {
                                    errors.tel && (
                                        <div className="flex p-4 mt-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                                            ...
                                            <span className="sr-only">Info</span>
                                            <div>
                                                <span className="font-medium">{errors.tel.message}</span>
                                            </div>
                                        </div>
                                    )
                                }
