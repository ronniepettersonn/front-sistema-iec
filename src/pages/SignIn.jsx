...
export function SignIn() {
    ...
    const { signIn, roles, isLoading, setIsLoading } = useAuth()
        ...
        <div className="flex justify-center items-center h-[100vh]">
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)} id="formLogin">
                    ...
                    <button type="submit" disabled={isLoading} form='formLogin' className="w-full disabled:bg-zinc-400 disabled:dark:bg-zinc-400 disabled:cursor-not-allowed text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >
                        {
                            isLoading === true ?
                                <div className='flex justify-center'>
                                    <div role="status" className="flex text-sm text-zinc-600 font-bold">
